...
function AddItem() {
    ...
    const [frontendImage, setFrontendImage] = useState(null);  // ye vo hai jo hmm frontnend pr show kr rhe h
    const [backendImage, setBackendImage] = useState(null); // ye vo hai jo backend pr send kr rhe h

    const [category, setCategory] = useState("")
    const [foodType, setFoodType] = useState("veg") // by default veg hoga
