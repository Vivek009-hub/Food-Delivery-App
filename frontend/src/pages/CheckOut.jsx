...
function CheckOut() {
  ...
  // },[address])  // ye jo hmne address likha hai it mean jb jb hmara address update hoga tb tb location update hogi

  const onDragEnd = (e) => {
    // console.log(e)   iss console se bs hoga ye hme console me jaake dekhna hai lat orr long kha mil rhe hai fir hmm vo access kr skte hai easily
  ...
  // razorpay ki mostly chhij already fixed hai 
  const openRazorpayWindow = (orderId, razorOrder) => {
    ...
    const options = {
      ...
      handler: async function (response) {      // iss handler ke andr hi hmm functional call krte hai like whenver we click pay so that function will be called 
        try {
      ...
      <div className='w-full max-w-[900px] bg-white rounded-2xl shadow-xl p-6 space-y-6'>
          ...
          <div className='rounded-xl border overflow-hidden'>
            <div className='h-64 w-full flex items-center justify-center'>
              ...
              >
                ...
                {/* when we drag to any position and stop it then it will will call function for that end(location)*/}
        ...
        <section>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
            <div className={`flex items-center gap-3 rounded-xl border p-4 text-left transition ${paymentMethod == "cod" ? "border-[#ff4d2d] bg-orange-50 shadow" : "border-gray-200 hover:border-gray-200"}`} onClick={() => setPaymentMethod("cod")}>
            ...
            <div className={`flex items-center gap-3 rounded-xl border p-4 text-left transition ${paymentMethod == "online" ? "border-[#ff4d2d] bg-orange-50 shadow" : "border-gray-200 hover:border-gray-200"}`} onClick={() => setPaymentMethod("online")}>
        ...
        <section>
          ...
          <div className='rounded-xl border bg-gray-50 p-4 space-y-2'>
            {cartItems.map((item, index) => (
              <div key={index} className='flex justify-between text-sm text-gray-70'>
