...
function EditItem() {
    ...
    const [frontendImage, setFrontendImage] = useState("");  // ye vo hai jo hmm frontnend pr show kr rhe h
    const [backendImage, setBackendImage] = useState(null); // ye vo hai jo backend pr send kr rhe h

    const [category, setCategory] = useState("");
    const [foodType, setFoodType] = useState("") // by default veg hoga
    ...
    useEffect(() => {
        ...
        // setBackendImage(null); // Reset backend image to null when loading a new item
    }, [currentItem])
    return (
